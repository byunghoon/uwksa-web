...
//$post_id, $pinned, $board_id, $title, $content, $user_id
	echo DBSavePost(-1, $params['pinned'], $params['bName'], $params['title'], $params['content'],$_SESSION['UserID'], $params['addedTags'], $params['deletedTags']); //BY: $_SESSION['added/deletedTags'] to $params['added/deletedTags']
} else if($request == 'editPost') {
	if ($params['pId']) {
		DBSavePost ($params['pId'],$params['pinned'], $params['bName'], $params['title'], $params['content'], $_SESSION['UserID'], $params['addedTags'], $params['deletedTags']); //BY: $_SESSION['added/deletedTags'] to $params['added/deletedTags']
	}
